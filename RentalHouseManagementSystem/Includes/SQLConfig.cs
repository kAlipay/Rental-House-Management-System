...
namespace RentalHouseManagementSystem.Includes
{
    class SQLConfig
    {

        private MySqlConnection con = new MySqlConnection("server=localhost;user id=root;database=dbrentalhouse;sslMode=none");
